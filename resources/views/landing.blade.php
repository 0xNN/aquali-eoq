                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('images') }}/aquali.png" alt="Aquali">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            @auth
                                <li class="scroll-to-section"><a href="{{ url('/home') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Home</a></li>
                                {{-- <a href="{{ url('/home') }}"
                    ...
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h2>PT Barokah Arsakha Putra</h2>
                                        <p>Aplikasi Pengendalian Persediaan Bahan Baku Air Minum Dalam Kemasan Aquali pada PT Barokah Arsakha Putra Menggunakan Metode Economic Order Quantity (EOQ) Berbasis Website</p>
                                    </div>
                                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                                <img src="{{ asset('assets') }}/assets/images/slider-dec.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
