            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="kode_permintaan" id="kode_permintaan" readonly>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @if (auth()->user()->role == 'admin' || auth()->user()->role == 'keuangan' || auth()->user()->role == 'gudang')
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            let btn = "Simpan";
            let idUpdate = null;
            let table = $('#tablePermintaan').DataTable({
                processing: true,
                serverSide: true,
            ...
            $('#btnSimpan').click(function() {
                if (validate()) {
                    ...
                    formData.append('kode_permintaan', $('#kode_permintaan').val());
